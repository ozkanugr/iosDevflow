...
4. **Generate Tasks**: `/generate-tasks <feature>` — Feature specification with implementation task breakdown
...
| `/generate-tasks <feature>` | Generate feature specification with implementation task breakdown |
